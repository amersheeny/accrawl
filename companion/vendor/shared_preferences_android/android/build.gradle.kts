...
plugins {
    // The inline migration marker also avoids Flutter 3.44.8's legacy-KGP
    // detector falsely applying KGP to this built-in-Kotlin module.
    id("com.android.library" /* AGP 9 built-in Kotlin */)
}
