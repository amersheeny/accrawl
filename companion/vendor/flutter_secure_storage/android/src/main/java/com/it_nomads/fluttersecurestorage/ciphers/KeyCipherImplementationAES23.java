...
class KeyCipherImplementationAES23 implements KeyCipher {
    ...
    private static final int LEGACY_DEVICE_CREDENTIAL_VALIDITY_SECONDS = 10;
    ...
    private void configureLegacyAuth(KeyGenParameterSpec.Builder builder) {
        // Android 9–10 cannot bind a CryptoObject to DEVICE_CREDENTIAL.
        // Strong-biometric-only keys remain auth-per-use; credential-capable
        // keys use the platform's time-based Keyguard authorization instead.
        builder.setUserAuthenticationValidityDurationSeconds(
                config.isStrongBiometricOnly()
                        ? -1
                        : LEGACY_DEVICE_CREDENTIAL_VALIDITY_SECONDS);
    }
