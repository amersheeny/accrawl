...
public class StorageCipherFactory {
    ...
    public boolean isSavedKeyStoreBacked() {
        return savedKeyAlgorithm == KeyCipherAlgorithm.AES_GCM_NoPadding;
    }

    public boolean isCurrentKeyStoreBacked() {
        return currentKeyAlgorithm == KeyCipherAlgorithm.AES_GCM_NoPadding;
    }

    public String getSavedKeyAlgorithmName() {
        return savedKeyAlgorithm.name();
    }

    public String getCurrentKeyAlgorithmName() {
        return currentKeyAlgorithm.name();
    }
